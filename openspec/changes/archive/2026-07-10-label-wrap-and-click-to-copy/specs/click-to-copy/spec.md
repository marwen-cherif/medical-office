...
Permettre aux utilisateurs de copier rapidement et facilement n'importe quelle information textuelle affichée dans l'interface en cliquant dessus, tout en fournissant une confirmation visuelle claire et fluide (icône temporaire de validation, effet au survol, toast subtil).
