...
Permettre de planifier des rappels datés (alertes internes pour le praticien ou messages à envoyer au patient via WhatsApp) rattachés ou non à des patients et des documents, avec déclenchement automatique par tâche planifiée Windows (notifications et mise en file d'attente) et envoi assisté en un clic via WhatsApp dans l'application.
