...
Fournir un référentiel autonome d'actes tarifés (libellé + prix), géré depuis un onglet
de Paramétrage (recherche, liste paginée, création / édition / retrait non destructif), et
exposer une lecture réutilisable du prix courant d'un acte pour permettre à d'autres
fonctionnalités (plans de traitement, facturation multi-lignes) de pré-remplir des
montants. L'introduction du référentiel est purement additive et ne modifie aucune donnée
existante.
