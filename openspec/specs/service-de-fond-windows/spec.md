# Capability: Service de fond Windows (Worker Tray)

## Purpose
Assurer l'exécution continue et transparente d'un worker de fond chargé du traitement des rappels de rendez-vous et de l'affichage des notifications locales à l'utilisateur, pilotable via une icône dans la zone de notification Windows.
